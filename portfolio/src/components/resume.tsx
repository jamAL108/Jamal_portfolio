...
const Thankyou = () => {
    return (
        <div className="w-[95%] max-w-[95%] relative px-5 py-5 pb-6 bg-radialCC rounded-xl flex flex-col gap-5">
            <p className='text-muted-foreground text-sm font-[600] flex items-center gap-3'><span className='text-2xl'>✨</span> <span>Additionally, you can download my resume below.</span></p>
