...
const Thankyou = () => {
    return (
        <div className="w-[95%] max-w-[95%] relative px-5 py-5 pb-6 bg-radialCC rounded-xl flex flex-col gap-5">
            ...
            <Link href={'https://drive.google.com/file/d/1Y4CymLYo9FFznW98Ud8Bku0gZUAzdhmZ/view?usp=sharing'} className="hoverme border bg-[#020617] hover:bg-[#020617]/60 rounded-xl relative px-5 flex items-center justify-center gap-2 py-4 font-[450] text-[0.9rem] !cursor-pointer min-w-[230px]">
                Checkout my resume
