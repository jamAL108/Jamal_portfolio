    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2  top-1/2  flex justify-start items-start  border-2 rounded-2xl  shadow-[0_8px_16px_rgb(0_0_0/0.4)] transition duration-700 overflow-hidden"
        >
    ...
    <motion.div className="w-96 h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        ...
        <div
          ...
          className="absolute pointer-events-none left-1/2 top-1/2 ml-[0.09375rem] mt-4 -translate-x-1/2 -translate-y-1/2"
        >
          <>
            <motion.div
              initial={{
